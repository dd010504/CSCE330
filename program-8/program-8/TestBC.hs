...
score = scConvert + scVNString + scInt2Base + scNum2Char + scDig2Int + scIndexInto 
  where 
    scIndexInto = test2 "test: indexInto " indexInto [0,5,10] [[0..10],[0..10],[0..10]] [0,5,10] 2
    scDig2Int   = test1 "test: dig2Int " dig2Int ['0','9','A','Z'] [0,9,10,35] 3
    scNum2Char  = test1 "test: num2char " num2char [0,9,10,35] ['0','9','A','Z'] 2
    scInt2Base  = test2 "test: int2Base " int2Base [10,10,10,34,34,71,115] [2,16,30,35,34,35,11] ["1010","A","A","Y","10","21","A5"] 8
    scVNString  = test2 "test: valNumString " valNumString ["1010","A","A","Y","10","21","A5"] [2,16,30,35,34,35,11]  [10,10,10,34,34,71,115] 7
    scConvert  = test3 "test: convert " convert ["1010","1010","1010","1111","1111","13"] [2,2,2,2,2,12] [10,16,33,10,12,2] ["10","A","A","15","13","1111"] 3
